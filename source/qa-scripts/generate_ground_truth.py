...
def main(session_dir):
    save_dir = os.path.join(os.getcwd(), '../results', '{}-{}'.format(
        'qa-database', str(time.time())))
    print(save_dir)
    face_changes_list_file = os.path.join(session_dir, 'db',
    ...
    reg_image_face_dict_file = os.path.join(session_dir, 'db',
